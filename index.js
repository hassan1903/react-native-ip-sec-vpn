...
exports.disconnect =
  exports.getCharonErrorState =
  exports.getCurrentState =
  exports.connect =
  exports.prepare =
  exports.onStateChangedListener =
  exports.removeOnStateChangeListener =
  exports.STATE_CHANGED_EVENT_NAME =
  exports.CharonErrorState =
  exports.VpnState =
    void 0;
...
exports.disconnect = (vpnType, username) => react_native_1.NativeModules.RNIpSecVpn.disconnect(vpnType, username);
